-- The previous feedback trigger predates card_summary. Recreate it after the
-- column exists so human edits to swipe-card copy improve future imports too.
...
after update of activity_name, address, borough, category, start_time, end_time,
  description, card_summary, cost, age_suitability, admin_cover_image_url,
  user_image_url, website, organiser_website, google_link, google_place_uri
