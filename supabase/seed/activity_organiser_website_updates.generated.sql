...
update public.activities
set
  organiser_website = 'https://gravityperformingarts.com/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/gravity-performing-arts-%';

update public.activities
set
  organiser_website = 'https://www.hmdtmusic.org.uk/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/hmdt-music-%';

update public.activities
set
  organiser_website = 'https://www.theperformingartsfactory.com/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/the-performing-arts-factory-%';

update public.activities
set
  organiser_website = 'https://www.toddlersense.com/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/toddler-sense-%';

update public.activities
set
  organiser_website = 'https://www.diddidance.com/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/diddi-dance-%';

update public.activities
set
  organiser_website = 'https://www.archwaydanceacademy.co.uk/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/archway-dance-academy-%';

update public.activities
set
  organiser_website = 'https://www.buggy-belles.com/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/buggy-belles-%';

update public.activities
set
  organiser_website = 'https://www.pausestudio.co.uk/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/pause-yoga-studio-%';

update public.activities
set
  organiser_website = 'https://blossombabies.classforkids.io/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/blossom-babies-%';

update public.activities
set
  organiser_website = 'https://www.balletnorth.co.uk/',
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/ballet-north-%';
...
set
  ...
  updated_at = now()
where source_name = 'Happity'
  and source_url like 'https://www.happity.co.uk/schedules/yonder-studio-%';

update public.activities
set
  organiser_website = 'https://boxxkids.co.uk/',
  updated_at = now()
where source_name = 'Happity'
