...
function normalizeActivity(activity) {
  ...
  const normalized = {
    ...
    model_selected_confidence: Number.isFinite(Number(activity.model_selected_confidence))
      ...
      : null,
    model_selected_original_url: activity.model_selected_original_url || null,
    model_selected_source_url: activity.model_selected_source_url || null,
    model_selected_source_field: activity.model_selected_source_field || null,
    model_selected_reason: activity.model_selected_reason || null,
    model_selected_model: activity.model_selected_model || null,
    model_selected_model_version: activity.model_selected_model_version || null,
    ...
    reviewed_image_model: activity.reviewed_image_model || null,
    audit_image_url: activity.audit_image_url || null,
    audit_image_source_url: activity.audit_image_source_url || null,
    audit_image_status: activity.audit_image_status || null,
    audit_image_original_url: activity.audit_image_original_url || null,
    audit_image_original_source_field: activity.audit_image_original_source_field || null,
